  ...
  return (
    <section className={outerClasses}>
      <div className='container border'>
        <h1>PART 1: YOUR NAME AND KEY DETAILS</h1>
        <form
          id='form-part'
        ...
        >
          <h6>
            ...
            you write down should match what is on your government-issued ID. If
            a box doesn’t apply to you, please just leave it blank.
          </h6>
          ...
          <h6>
            ...
            please fill in all you can. Note that you must provide the Province
            and the name of your Band, and either your Indian Status Card Number
            and/or your Band Registration Number
          </h6>
          ...
          <h6>
            ...
            where you can be reached. We also ask for your phone number and
            email, but if you don’t have those that’s fine, please just leave
            those boxes blank.
          </h6>
          <h6>
            Current mailing address or the address where you can be reached
          </h6>
          ...
          <label htmlFor='po'>
            <input type='radio' id='po' name='address' onClick={toggleInput} />
            PO Box
          </label>
          {poBoxInput && (
            <input
          ...
          {firstNationNameInput && (
            <>
              <label htmlFor='firstNation'>
                First Nation Name of Contact Address
              </label>
              <input
          ...
          {gID && (
            <>
              <label htmlFor='governmentID'>
                Please attach a copy of a government-issued ID for yourself
                (required)
              </label>
          ...
          {modal && (
            <>
              <h6>
                Please upload a scanned photocopy or photograph of one piece of
                current government issued identification (ID). This can include
                any of the following Federal, Provincial or Territorial
